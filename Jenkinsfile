                ...
                stage('ubuntu')
                {
                    ...
                    stages
                    {
                        ...
                        stage('ubuntu package')
                        {
                            steps
                            {
                                sh 'make package ARGS="--python-version=3.7,2 --target-wheel-platform=manylinux_2_27_x86_64 --chrono --config=Development"'
                                sh 'make package ARGS="--packages=AdditionalMaps,Town06_Opt,Town07_Opt,Town11,Town12 --target-archive=AdditionalMaps --clean-intermediate --python-version=3.7,2 --target-wheel-platform=manylinux_2_27_x86_64 --config=Development"'
                    ...
                    stages
                    {
                        ...
                        stage('windows package')
                        {
                            steps
                            {
                                ...
                                bat """
                                    call ../setEnv64.bat
                                    make package ARGS="--packages=AdditionalMaps,Town06_Opt,Town07_Opt,Town11,Town12 --target-archive=AdditionalMaps --clean-intermediate --config=Development"
                                """
                            }
                            post {
                                always {
